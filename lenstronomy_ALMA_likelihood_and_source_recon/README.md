...
- ALMA Point Source Fitting Tests:
  We test the ALMA image fitting in three senarios that involve point sources: **unlensed point sources**, **point-source source galaxy**, and **quadruply imaged quasar**. The result shows the likelihood function works well for point source as well.
